...
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; } // eslint-disable-line no-unsafe-negation, no-global-assign
  ...
  return function (Target) {
    ...
    return _temp2 = _class = function (_Component) {
      ...
      function ReduxReactLocal() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = ReduxReactLocal.__proto__ || Object.getPrototypeOf(ReduxReactLocal)).call.apply(_ref2, [this].concat(args))), _this), _this.mappedProps = mapProps(_this.props), _this.store = _this.context.store, _this.state = function () {
      ...
      _createClass(ReduxReactLocal, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
          return !shallowEqual(this.mappedProps, mapProps(nextProps)) || this.state.id !== nextState.id || this.state.value !== nextState.value;
        }
      }, {
